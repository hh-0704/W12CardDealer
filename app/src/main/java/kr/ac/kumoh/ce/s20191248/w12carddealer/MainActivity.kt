package kr.ac.kumoh.ce.s20191248.w12carddealer
...
import kr.ac.kumoh.ce.s20191248.w12carddealer.ui.theme.W12CardDealerTheme
...
//    cardResources[0] = R.drawable.c_10_of_clubs
//    cardResources[1] = R.drawable.c_10_of_clubs
//    cardResources[2] = R.drawable.c_10_of_clubs
//    cardResources[3] = R.drawable.c_10_of_clubs
//    cardResources[4] = R.drawable.c_10_of_clubs
...
fun ColumnScope.CardImages(res: IntArray) {
    if (LocalConfiguration.current.orientation
        ...
        Row (modifier = Modifier
            ...
            Image(painter = painterResource(res[0]),
                contentDescription = "1st card",
                modifier = Modifier.fillMaxHeight().padding(4.dp).weight(1f)
            )
            Image(painter = painterResource(res[1]),
                contentDescription = "2nd card",
                modifier = Modifier.fillMaxHeight().padding(4.dp).weight(1f)
            )
            Image(painter = painterResource(res[2]),
                contentDescription = "3rd card",
                modifier = Modifier.fillMaxHeight().padding(4.dp).weight(1f)
            )
            Image(painter = painterResource(res[3]),
                contentDescription = "4th card",
                modifier = Modifier.fillMaxHeight().padding(4.dp).weight(1f)
            )
            Image(painter = painterResource(res[4]),
        ...
        Column (Modifier.weight(1f).background(Color(0,100,0))) {
